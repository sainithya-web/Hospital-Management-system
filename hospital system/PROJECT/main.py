...
def patient():
    ...
    if request.method=="POST":
        ...
        # Note: Allow less secure app permission to get mail..
...
@login_required
def details_view():
    # This pulls all users who registered as 'Patient'
    # 'User' should be the name of your database model for logins
    query = User.query.filter_by(usertype='Patient').all()
